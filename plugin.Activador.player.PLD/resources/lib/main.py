...
def LOGIN(username,password,hidesuccess):
	...
	if logged_in == True:
		...
		Bienve1 = dialogo.ok('[COLOR red]Bienvenidos a [/COLOR]***[COLOR blue]PROYECTOLUZDIGITAL[/COLOR]***','[COLOR red]     El plugin PLAYER [COLOR blue]Proyectoluzdigital[/COLOR][COLOR red] esta Activado[/COLOR]   [/COLOR]','Esperamos Disfruteis de este plugin hecho para ustedes, PLD no se hace RESPONSABLE del uso que les den a este plugin esto es solo, con fines de investigacion.','[COLOR blue]----------------------[COLOR blue] http://proyectoluzdigital.info[/COLOR]-----------------------[/COLOR] ')
		import activador
