...
def ninestreams(params):
    plugintools.log("[PLD.VisionTV-0.3.0].ninestreams "+repr(params))
    url_user = {}
...
def getparams_ninestream(url_user, params, body):
    plugintools.log("[PLD.VisionTV-0.3.0].getparams_ninestream " + repr(url_user) )
...
def getfile_ninestream(url_user, decoded, body):
    plugintools.log("PLD.VisionTV getfile_ninestream( "+repr(url_user))
    referer = url_user.get("referer")
