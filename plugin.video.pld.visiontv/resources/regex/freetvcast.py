# -*- coding: utf-8 -*-
#------------------------------------------------------------
# PLD.VisionTV Regex de freetvcast
...
def freetvcast(params):
    plugintools.log("[PLD.VisionTV-0.3.0].resolve_freetvcast " + repr(params) )
...
def play_freetvcast(freetvcast_user):
    plugintools.log("[PLD.VisionTV-0.3.0].freetvcast User= " + repr(freetvcast_user) )
