# -*- coding: utf-8 -*-
#------------------------------------------------------------
# PLD.VisionTV Regex de castalba
...
home = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PLD.VisionTV/', ''))
tools = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PLD.VisionTV/resources/tools', ''))
addons = xbmc.translatePath(os.path.join('special://home/addons/', ''))
resources = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PLD.VisionTV/resources', ''))
art = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PLD.VisionTV/art', ''))
tmp = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PLD.VisionTV/tmp', ''))
...
# En construcción!
def castalba(params):
    plugintools.log("[PLD.VisionTV-0.3.0].castalba "+repr(params))
...
def castalba(params):
    ...
    if body.find("THIS CHANNEL IS CURRENTLY OFFLINE") > 0 :
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('PLD.VisionTV', "Canal offline", 3 , art+'icon.png'))
        return 0
    else:
