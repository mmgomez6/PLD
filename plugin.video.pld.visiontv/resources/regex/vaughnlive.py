# -*- coding: utf-8 -*-
#------------------------------------------------------------
# PLD.VisionTV Regex de vaughnlive
...
def resolve_vaughnlive(params):
    plugintools.log("[PLD.VisionTV-0.3.0].resolve_vaughnlive " + repr(params) )
    ...
    # PLD.VisionTV: rtmp://198.255.5.66:443/live?0n0qMt6OtXhOLwQKIwSoxVdmXHiYW8nVZSY playpath=live_dibujos_animados live=1 timeout=20
...
def gethttp_noref(url):
    plugintools.log("[PLD.VisionTV-0.3.0.Vaughn_Regex] ")    
