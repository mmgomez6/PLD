# -*- coding: utf-8 -*-
#------------------------------------------------------------
# PLD.VisionTV - XBMC Add-on by Juarrox (juarrox@gmail.com)
...
def freebroadcast(params):
    plugintools.log("[PLD.VisionTV-0.3.0].freebroadcast "+repr(params))
    url_user = {}
...
def getparams_freebroadcast(url_user, body):
    plugintools.log("[PLD.VisionTV-0.3.0].getparams_freebroadcast " + repr(url_user) )
...
def getfile_freebroadcast(url_user, decoded, body):
    plugintools.log("PLD.VisionTV getfile_freebroadcast( "+repr(url_user))
    referer = url_user.get("referer")
...
def get_fileserver(decoded, url_user):
    plugintools.log("PLD.VisionTV fileserver "+repr(url_user))
