# -*- coding: utf-8 -*-
#------------------------------------------------------------
# PLD.VisionTV Regex de Shidurlive
...
def shidurlive(params):
    plugintools.log("[PLD.VisionTV-0.3.0].shidurlive "+repr(params))
    url_user = {}
...
def getparams_shidurlive(url_user, body):
    plugintools.log("[PLD.VisionTV-0.3.0].getparams_shidurlive " + repr(url_user) )
