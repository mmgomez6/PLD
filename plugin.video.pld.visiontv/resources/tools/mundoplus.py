# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Guía de próximos capítulos de Mundoplus.tv para PLD.VisionTV
# Version 0.1
#------------------------------------------------------------
...
def mundoplus_guide(params):
    plugintools.log('[%s %s] Mundoplus: Guía de próximos capítulos en TV... %s' % (addonName, addonVersion, repr(params)))
...
def mundoplus0(params):
    ...
    try:
        ...
        params["plot"]=texto
        texto = texto.lower()        
        if texto == "": errormsg = plugintools.message("PLD.VisionTV","Por favor, introduzca serie a buscar");return errormsg
        else:
