# -*- coding: utf-8 -*-
#------------------------------------------------------------
# PLD.VisionTV EPG FórmulaTV.com
...
def epg_ftvmov(title):
    ...
    # Selector de guías de programación FTV   
    params = plugintools.get_params()
    #params["url"]='http://www.formulatv.com/programacion/movistarplus/'
    if plugintools.get_setting("epg_source") == 0:
        params["url"] = 'http://www.formulatv.com/programacion'
    elif plugintools.get_setting("epg_source") == 1:
        params["url"] = 'http://www.formulatv.com/programacion/movistarplus/'
    elif plugintools.get_setting("epg_source") == 2:
        params["url"] = 'http://www.formulatv.com/programacion/ono/'
    elif plugintools.get_setting("epg_source") == 3:
        params["url"] = 'http://www.formulatv.com/programacion/telecable/'
    elif plugintools.get_setting("epg_source") == 4:
        params["url"] = 'http://www.formulatv.com/programacion/jazztel/'
